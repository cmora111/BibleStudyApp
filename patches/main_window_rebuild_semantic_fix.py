...
class UltimateBibleApp:
    ...
    def rebuild_semantic_index(self) -> None:
        translation = (self.translation_var.get() or "").strip()
        ...
        try:
            ...
            try:
                ...
                self.search_results.insert("end", f"Semantic index rebuilt for {translation.upper() or 'current translation'}.\n")
            except Exception:
                pass
            self.status_var.set(f"Semantic index rebuilt for {translation.upper() or 'current translation'}")
